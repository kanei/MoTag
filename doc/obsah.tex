...
\paragraph*{Definice}
HMM je koneèným automatem, vyjádøeným jako $(A, B, \Pi)$, kde $A$ popisuje hodnoty pravdìpodobnosti pøechody, $B$ hodnoty pravdìpodobnosti generování (výstupu) $\Pi$ hodnoty pravdìpodobnosti úvodního stavu $ B $. Mno¾ina skrytých stavù $ Q $ a seznam výstupních hodnot (pozorování) $ O $ jsou známy a nejsou tedy zahrnuty do definice. Aktuální stav není pozorovatelný a místo toho ka¾dý stav s urèitou pravdìpodobností($B$) generuje výstup.
\begin{gather}
	\Lambda = (A, B, \Pi)\\
	\Pi = {p_i = P(q_i[t = 1])}\\
	Q = {q_i}, i=1,...,N
...
$O$ je tedy pravdìpodobnost, ¾e výstup je $o_k$ za pøedpokladu, ¾e aktuálním stavem je $q_i$
...
\paragraph*{Pøíklad}
Zatímco u klasického Markovského modelu známe posloupnost vstupních hodnot, v na¹em pøípadì známe pouze posloupnost hodnot výstupních (slovních tvarù). V ka¾dém kroku je poté ulo¾ena hodnota pravdìpodobnosti pøechodu do mo¾ných následujících stavù a hodnota pravdìpodobnosti vygenerování urèitého výstupu (znaèky). Celý proces bude vysvìtlen na obrázku obrázku~\ref{fig:GrafHMM}. 
...
\paragraph{Prùbìh algoritmu} 
Abychom získali v prvním kroku kruh, musíme aktuální stav, ve kterém se nacházíme, mít mo¾nost vyprodukovat kruh -- v na¹em pøípadì \emph{Stav 1} a \emph{Stav 2}. Zapí¹eme je tedy jako úvodní stavy. Abychom jako druhý prvek posloupnosti získali kosoètverec, musíme být ve \emph{Stavu 2}, nebo» ten jako jediný poskytuje tento obrazec. Pøi prvním kroku jsme si vypsali \emph{Stav 1} a \emph{Stav 2}, ze \emph{Stavu 2} se v¹ak zpìt do \emph{Stavu 2} nemù¾eme dostat a tudí¾ vypadává z mo¾ných posloupností a zùstává nám posloupnost (\emph{Stav 1}~$\rightarrow$~\emph{Stav 2}). Kdybychom takto pokraèovali a¾ do konce, získáme ètyøi mo¾nosti, zachycené v tabulce~\ref{tab:HMMPrechody}. Nejpravdìpodobnìj¹í z nich bychom byli schopni urèit pomocí ohodnocení jednotlivých pøechodù a výbìrem toho s nejvy¹¹í pravdìpodobností. 

\paragraph{Vyu¾ití}
V pøípadì vyu¾ití k na¹emu úèelu v¹ak neznáme $B$, které bychom museli natrénovat pomocí algoritmù popsaných v dal¹ích kapitolách. S jejich pomocí jsme po nìkolika iteracích schopni získat hodnoty pro co nejpravdìpodobnìj¹í prùchod.
...
\begin{table}[bp]
	\begin{center}
		\begin{tabular}{|c|r|r|r|r|r|r|r|r|}
			...
			\multicolumn{1}{|c|}{vìt} \\
			\hline
			10000 & 27 & 8h 37m & 36 244 KB & 905326 & 92.34\% & 42.85\% \\
			20000 & 29 & 21h 40m & 57 072 KB & 1464587 & 93.33\% & 48.67\% \\ 
			30000 & 35 & 30h 13m & 76 696 KB & 2002349 & 93.96\% & 51.60\% \\ 
			40000 & 36 & 41h 25m & 94 190 KB & 2488724 & 94.31\% & 53.45\% \\ 
			\hline
		\end{tabular}
...
\begin{table}[bp]
	\begin{center}
		\begin{tabular}{|c|r|r|r|r|r|r|r|r|}
			...
			\multicolumn{1}{|c|}{vìt} \\
			\hline
			35 & 30h 13m & 76 696 KB & 2002349 & 93.96\% & 51.60\% \\ 
			57 & 48h 38m & 76 696 KB & 2002356 & 94.01\% & 52.16\% \\ 
			57 & 52h 10m & 76 696 KB & 2002350 & 94.01\% & 52.16\% \\ 
			\hline
		\end{tabular}
...
\begin{table}
	\begin{center}
		\begin{tabular}{|c|l|r|r|r|r|}
			...
			\hline
			    & Celkem & 508730 & -260770 & -9 539 736B & \\
			\hline
			    & Teoretický výsledek & 1493626 & 227474 & 10 182 796B & \\
			\hline
		\end{tabular}
